<template>
  <v-container class="tw-flex tw-justify-center tw-items-center tw-h-full">
    <div class="tw-text-center tw-px-5">
      <p v-if="!score.getScore" class="md:tw-text-3xl tw-mb-8 tw-font-bold">กรุณากดปุ่ม Start เพื่อเริ่มต้นทำแบบสอบถาม</p>
      <p v-else class="md:tw-text-3xl tw-mb-8 tw-font-bold">กดที่ปุ่ม Start เพื่อเริ่มต้นทำแบบสอบถามใหม่<br/>หรือ กดที่ปุ่ม View เพื่อดูประวัติคะแนน</p>
