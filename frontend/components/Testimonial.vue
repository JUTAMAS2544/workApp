<template>
  <div class="tw-relative">
    <div class="tw-flex tw-justify-center tw-items-center tw-gap-x-8 tw-absolute tw-z-10 tw-w-full" >
      <img src="/egg-1.png" alt="Testimonial" class="tw-h-10 md:tw-h-12" >
